//引入展示员工列表的方法
document.write("<script type='text/javascript' src='static/js/include/emps.js'></script>");
// 引入展示分页的方法
document.write("<script type='text/javascript' src='static/js/include/paging.js'></script>");
//引入校验表单数据的方法
document.write("<script type='text/javascript' src='static/js/include/validate_form.js'></script>");
